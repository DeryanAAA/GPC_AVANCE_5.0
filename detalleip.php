				  ...
				  <div class="card-body">
					...
					<form class="form-sample" method="post" action="controladoreditip.php">
					  ...
					  <div class="row">
						<div class="col-md-6">
						  ...
						  <div class="form-group row">
							...
							<div class="col-sm-9" name="cc" id="cc">
							  <section class="form-control">
						 <?php 
							$query = "SELECT CENTRO_DE_COSTO.ID_CC, CENTRO_DE_COSTO.NOM_CC FROM CENTRO_DE_COSTO, INFORME_DE_PAGO WHERE CENTRO_DE_COSTO.ID_CC = INFORME_DE_PAGO.ID_CCosto AND INFORME_DE_PAGO.ID_IP = '$id_ip'";
							$result = $conexion->query($query);
							?>							
								  <?php 
									while ($row7 = $result->fetch_array() )
							...
							?>
												  <div class="form-group row">
													...
													<div class="col-sm-9">
													  <section	class="form-control">
									  <?php 
							$query = "SELECT CONCEPTO.CP, CONCEPTO.OTT FROM CONCEPTO, INFORME_DE_PAGO WHERE CONCEPTO.CP = INFORME_DE_PAGO.CP AND INFORME_DE_PAGO.ID_IP = '$id_ip'";
							$result = $conexion->query($query);
							?>							
								  <?php 
									while ($row7 = $result->fetch_array())
							...
							?>
												  <div class="form-group row">
													...
													<div class="col-sm-9">
													  <section	class="form-control">
									  <?php 
							$query = "SELECT FACTURA.ID_FACT, FACTURA.NFACT FROM FACTURA, INFORME_DE_PAGO WHERE FACTURA.ID_FACT = INFORME_DE_PAGO.ID_FACTURA AND INFORME_DE_PAGO.ID_IP = '$id_ip'";
							$result = $conexion->query($query);
							?>							
								  <?php 
									while ($row7 = $result->fetch_array() )
                        ...
                        <div class="col-md-6">
														   <?php 
							$query2 = "SELECT * FROM ESTADO_COBRANZA";
							$result2 = $conexion->query($query2);
							?>
												  <div class="form-group row">
													...
													<div class="col-sm-9">
													  <section	class="form-control">
									  <?php 
							$query = "SELECT ESTADO_COBRANZA.ID_EO_COB, ESTADO_COBRANZA.NOM_EO_COB FROM ESTADO_COBRANZA, INFORME_DE_PAGO WHERE ESTADO_COBRANZA.ID_EO_COB = INFORME_DE_PAGO.ID_EO_COB AND INFORME_DE_PAGO.ID_IP = '$id_ip'";
							$result = $conexion->query($query);
							?>							
								  <?php 
									while ($row7 = $result->fetch_array() )
									{
									?>
										<option value=" <?php echo$row7['ID_EO_COB'] ?>">
										<?php echo $row7['NOM_EO_COB']; ?>
										</option>
							<?php } ?>							 
								</section>
                                     </div>
						...
						<div class="col-md-6">
                          ...
                          <div class="col-md-6">
							...
							?>
									  ...
									  <?php 
							$query = "SELECT CONCEPTO.CP, CONCEPTO.AVANCE FROM CONCEPTO, INFORME_DE_PAGO WHERE CONCEPTO.CP = INFORME_DE_PAGO.CP AND INFORME_DE_PAGO.ID_IP = '$id_ip'";
							$result = $conexion->query($query);
							?>							
								  <?php 
									while ($row7 = $result->fetch_array() )
